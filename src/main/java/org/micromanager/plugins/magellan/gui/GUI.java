...
import main.java.org.micromanager.plugins.magellan.propsandcovariants.LaserPredNet;
   ...
   public static SurfaceRegionComboBoxModel createSurfaceAndRegionComboBoxModel(boolean surfaces, boolean regions) {
    ...
    private void storeCurrentAcqSettings() {
        ...
        if (settings.autofocusEnabled_) {
            ...
            settings.autofocusExponentialWeight_ = (Double) autofocusExponentialWeightSpinner_.getValue();
            settings.autofocusInitalDriftEstimate_ = (Double) autofocusInitialDriftEstimateSpinner.getValue();
        }
    ...
    private void populateAcqControls(FixedAreaAcquisitionSettings settings) {
        ...
        autofocusInitialDriftEstimateSpinner.setValue(settings.autofocusInitalDriftEstimate_);
        autofocusExponentialWeightSpinner_.setValue(settings.autofocusExponentialWeight_);
    ...
    private void initComponents() {
        ...
        autofocusExponentialWeightSpinner_ = new javax.swing.JSpinner();
        expWeightLabel_ = new javax.swing.JLabel();
        initalDriftLabel_ = new javax.swing.JLabel();
        autofocusInitialDriftEstimateSpinner = new javax.swing.JSpinner();
        ...
        controlPanelName_Layout.setVerticalGroup(
            controlPanelName_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(deviceControlScrollPane_, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
        );
        ...
        covariedSettingsTab_Layout.setVerticalGroup(
            ...
            .addGroup(covariedSettingsTab_Layout.createSequentialGroup()
                ...
                .addGap(8, 8, 8)
                .addGroup(covariedSettingsTab_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(propertyPairValuesScrollpane_, javax.swing.GroupLayout.DEFAULT_SIZE, 429, Short.MAX_VALUE)
                    .addComponent(propertyPairingsScrollpane_, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(covariedSettingsTab_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(newParingButton_)
        ...
        autofocusExponentialWeightSpinner_.setModel(new javax.swing.SpinnerNumberModel(0.8d, 0.0d, 1.0d, 0.1d));
        autofocusExponentialWeightSpinner_.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                autofocusExponentialWeightSpinner_StateChanged(evt);
            }
        });

        expWeightLabel_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        expWeightLabel_.setText("ExponetialWeight");

        initalDriftLabel_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        initalDriftLabel_.setText("Intial drift per TP:");

        autofocusInitialDriftEstimateSpinner.setModel(new javax.swing.SpinnerNumberModel(10.0d, 0.0d, 50.0d, 1.0d));
        autofocusInitialDriftEstimateSpinner.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                autofocusInitialDriftEstimateSpinnerStateChanged(evt);
            }
        });
        ...
        autofocusComponentsPanel_Layout.setHorizontalGroup(
            ...
            .addGroup(autofocusComponentsPanel_Layout.createSequentialGroup()
                ...
                .addGroup(autofocusComponentsPanel_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(autofocusComponentsPanel_Layout.createSequentialGroup()
                        .addComponent(expWeightLabel_)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(autofocusExponentialWeightSpinner_, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(autofocusComponentsPanel_Layout.createSequentialGroup()
                        .addComponent(initalDriftLabel_)
                        .addGap(18, 18, 18)
                        .addComponent(autofocusInitialDriftEstimateSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        autofocusComponentsPanel_Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, autofocusComponentsPanel_Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(autofocusComponentsPanel_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(autofocusExponentialWeightSpinner_, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                    .addComponent(expWeightLabel_))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(autofocusComponentsPanel_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(initalDriftLabel_)
                    .addComponent(autofocusInitialDriftEstimateSpinner, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//               covariantPairingsTable_.getSelectedRow(), true));
   ...
   private void collectionPlaneCheckBox_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_collectionPlaneCheckBox_ActionPerformed
    ...
    private void autofocusExponentialWeightSpinner_StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_autofocusExponentialWeightSpinner_StateChanged
              acquisitionSettingsChanged();
    }//GEN-LAST:event_autofocusExponentialWeightSpinner_StateChanged

    private void autofocusInitialDriftEstimateSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_autofocusInitialDriftEstimateSpinnerStateChanged
              acquisitionSettingsChanged();

    }//GEN-LAST:event_autofocusInitialDriftEstimateSpinnerStateChanged
    ...
    private javax.swing.JSpinner autofocusExponentialWeightSpinner_;
    private javax.swing.JSpinner autofocusInitialDriftEstimateSpinner;
    ...
    private javax.swing.JLabel expWeightLabel_;
    ...
    private javax.swing.JLabel initalDriftLabel_;
